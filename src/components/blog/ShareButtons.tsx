  ...
  return (
    <div className={className}>
      <div className="relative inline-flex">
        <div className="absolute inset-0 -z-10 rounded-2xl bg-gradient-to-r from-fuchsia-500/40 via-cyan-400/40 to-amber-400/40 opacity-70 blur-xl" />
        <div className="rounded-2xl bg-[conic-gradient(at_0%_0%,#a78bfa_0%,#22d3ee_50%,#f59e0b_100%)] p-[1.5px]">
          <div className="inline-flex items-center gap-3 rounded-2xl bg-white/50 px-3 py-2 ring-1 ring-white/40 backdrop-blur-xl dark:bg-black/30 dark:ring-black/40">
