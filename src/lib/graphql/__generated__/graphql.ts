...
export type Contribution_Reactions = {
  __typename?: "contribution_reactions";
  /** An object relationship */
  contribution: Contributions;
  contribution_id: Scalars["uuid"]["output"];
  created_at: Scalars["timestamptz"]["output"];
...
export type Contribution_Reactions_Aggregate = {
  __typename?: "contribution_reactions_aggregate";
  aggregate?: Maybe<Contribution_Reactions_Aggregate_Fields>;
  nodes: Array<Contribution_Reactions>;
};

export type Contribution_Reactions_Aggregate_Bool_Exp = {
  count?: InputMaybe<Contribution_Reactions_Aggregate_Bool_Exp_Count>;
};

export type Contribution_Reactions_Aggregate_Bool_Exp_Count = {
  arguments?: InputMaybe<Array<Contribution_Reactions_Select_Column>>;
  distinct?: InputMaybe<Scalars["Boolean"]["input"]>;
  filter?: InputMaybe<Contribution_Reactions_Bool_Exp>;
  predicate: Int_Comparison_Exp;
};

/** aggregate fields of "contribution_reactions" */
export type Contribution_Reactions_Aggregate_Fields = {
  __typename?: "contribution_reactions_aggregate_fields";
  count: Scalars["Int"]["output"];
  max?: Maybe<Contribution_Reactions_Max_Fields>;
  min?: Maybe<Contribution_Reactions_Min_Fields>;
};

/** aggregate fields of "contribution_reactions" */
export type Contribution_Reactions_Aggregate_FieldsCountArgs = {
  columns?: InputMaybe<Array<Contribution_Reactions_Select_Column>>;
  distinct?: InputMaybe<Scalars["Boolean"]["input"]>;
};

/** order by aggregate values of table "contribution_reactions" */
export type Contribution_Reactions_Aggregate_Order_By = {
  count?: InputMaybe<Order_By>;
  max?: InputMaybe<Contribution_Reactions_Max_Order_By>;
  min?: InputMaybe<Contribution_Reactions_Min_Order_By>;
};

/** input type for inserting array relation for remote table "contribution_reactions" */
export type Contribution_Reactions_Arr_Rel_Insert_Input = {
  data: Array<Contribution_Reactions_Insert_Input>;
  /** upsert condition */
  on_conflict?: InputMaybe<Contribution_Reactions_On_Conflict>;
};

/** Boolean expression to filter rows from the table "contribution_reactions". All fields are combined with a logical 'AND'. */
export type Contribution_Reactions_Bool_Exp = {
  _and?: InputMaybe<Array<Contribution_Reactions_Bool_Exp>>;
  _not?: InputMaybe<Contribution_Reactions_Bool_Exp>;
  _or?: InputMaybe<Array<Contribution_Reactions_Bool_Exp>>;
  contribution?: InputMaybe<Contributions_Bool_Exp>;
  contribution_id?: InputMaybe<Uuid_Comparison_Exp>;
  created_at?: InputMaybe<Timestamptz_Comparison_Exp>;
  id?: InputMaybe<Uuid_Comparison_Exp>;
  type?: InputMaybe<Reaction_Types_Enum_Comparison_Exp>;
  updated_at?: InputMaybe<Timestamptz_Comparison_Exp>;
  user?: InputMaybe<Users_Bool_Exp>;
  user_id?: InputMaybe<Uuid_Comparison_Exp>;
};
...
export enum Contribution_Reactions_Constraint {
  /** unique or primary key constraint on columns "user_id", "type", "contribution_id" */
  ContributionReactionsPkey = "contribution_reactions_pkey",
}

/** input type for inserting data into table "contribution_reactions" */
export type Contribution_Reactions_Insert_Input = {
  contribution?: InputMaybe<Contributions_Obj_Rel_Insert_Input>;
  contribution_id?: InputMaybe<Scalars["uuid"]["input"]>;
  created_at?: InputMaybe<Scalars["timestamptz"]["input"]>;
  id?: InputMaybe<Scalars["uuid"]["input"]>;
  type?: InputMaybe<Reaction_Types_Enum>;
  updated_at?: InputMaybe<Scalars["timestamptz"]["input"]>;
  user?: InputMaybe<Users_Obj_Rel_Insert_Input>;
  user_id?: InputMaybe<Scalars["uuid"]["input"]>;
};
...
/** aggregate max on columns */
export type Contribution_Reactions_Max_Fields = {
  __typename?: "contribution_reactions_max_fields";
  contribution_id?: Maybe<Scalars["uuid"]["output"]>;
  created_at?: Maybe<Scalars["timestamptz"]["output"]>;
  id?: Maybe<Scalars["uuid"]["output"]>;
  updated_at?: Maybe<Scalars["timestamptz"]["output"]>;
...
export type Contribution_Reactions_Max_Order_By = {
  contribution_id?: InputMaybe<Order_By>;
  created_at?: InputMaybe<Order_By>;
  id?: InputMaybe<Order_By>;
  updated_at?: InputMaybe<Order_By>;
...
/** aggregate min on columns */
export type Contribution_Reactions_Min_Fields = {
  __typename?: "contribution_reactions_min_fields";
  contribution_id?: Maybe<Scalars["uuid"]["output"]>;
  created_at?: Maybe<Scalars["timestamptz"]["output"]>;
  id?: Maybe<Scalars["uuid"]["output"]>;
  updated_at?: Maybe<Scalars["timestamptz"]["output"]>;
...
export type Contribution_Reactions_Min_Order_By = {
  contribution_id?: InputMaybe<Order_By>;
  created_at?: InputMaybe<Order_By>;
  id?: InputMaybe<Order_By>;
  updated_at?: InputMaybe<Order_By>;
...
export type Contribution_Reactions_Mutation_Response = {
  __typename?: "contribution_reactions_mutation_response";
  /** number of rows affected by the mutation */
  affected_rows: Scalars["Int"]["output"];
  /** data from the rows affected by the mutation */
  returning: Array<Contribution_Reactions>;
};

/** on_conflict condition type for table "contribution_reactions" */
export type Contribution_Reactions_On_Conflict = {
  constraint: Contribution_Reactions_Constraint;
  update_columns?: Array<Contribution_Reactions_Update_Column>;
  where?: InputMaybe<Contribution_Reactions_Bool_Exp>;
};

/** Ordering options when selecting data from "contribution_reactions". */
export type Contribution_Reactions_Order_By = {
  contribution?: InputMaybe<Contributions_Order_By>;
  contribution_id?: InputMaybe<Order_By>;
  created_at?: InputMaybe<Order_By>;
  id?: InputMaybe<Order_By>;
...
export type Contribution_Reactions_Pk_Columns_Input = {
  contribution_id: Scalars["uuid"]["input"];
  type: Reaction_Types_Enum;
  user_id: Scalars["uuid"]["input"];
};
...
export enum Contribution_Reactions_Select_Column {
  /** column name */
  ContributionId = "contribution_id",
  /** column name */
  CreatedAt = "created_at",
...
export type Contribution_Reactions_Set_Input = {
  contribution_id?: InputMaybe<Scalars["uuid"]["input"]>;
  created_at?: InputMaybe<Scalars["timestamptz"]["input"]>;
  id?: InputMaybe<Scalars["uuid"]["input"]>;
  type?: InputMaybe<Reaction_Types_Enum>;
...
export type Contribution_Reactions_Stream_Cursor_Input = {
  /** Stream column input with initial value */
...
/** Initial value of the column from where the streaming should start */
export type Contribution_Reactions_Stream_Cursor_Value_Input = {
  contribution_id?: InputMaybe<Scalars["uuid"]["input"]>;
  created_at?: InputMaybe<Scalars["timestamptz"]["input"]>;
  id?: InputMaybe<Scalars["uuid"]["input"]>;
  type?: InputMaybe<Reaction_Types_Enum>;
...
export enum Contribution_Reactions_Update_Column {
  /** column name */
  ContributionId = "contribution_id",
  /** column name */
  CreatedAt = "created_at",
...
export type Contribution_Reactions_Updates = {
  /** sets the columns of the filtered rows to the given values */
  _set?: InputMaybe<Contribution_Reactions_Set_Input>;
  /** filter the rows which have to be updated */
...
export type Contributions = {
  ...
  /** An array relationship */
  contribution_reactions: Array<Contribution_Reactions>;
  /** An aggregate relationship */
  contribution_reactions_aggregate: Contribution_Reactions_Aggregate;
  created_at: Scalars["timestamptz"]["output"];
...
/** columns and relationships of "contributions" */
export type ContributionsContribution_ReactionsArgs = {
  distinct_on?: InputMaybe<Array<Contribution_Reactions_Select_Column>>;
  limit?: InputMaybe<Scalars["Int"]["input"]>;
  offset?: InputMaybe<Scalars["Int"]["input"]>;
  order_by?: InputMaybe<Array<Contribution_Reactions_Order_By>>;
  where?: InputMaybe<Contribution_Reactions_Bool_Exp>;
};

/** columns and relationships of "contributions" */
export type ContributionsContribution_Reactions_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Contribution_Reactions_Select_Column>>;
  limit?: InputMaybe<Scalars["Int"]["input"]>;
  offset?: InputMaybe<Scalars["Int"]["input"]>;
  order_by?: InputMaybe<Array<Contribution_Reactions_Order_By>>;
...
export type Contributions_Bool_Exp = {
  ...
  contribution_reactions?: InputMaybe<Contribution_Reactions_Bool_Exp>;
  contribution_reactions_aggregate?: InputMaybe<Contribution_Reactions_Aggregate_Bool_Exp>;
  created_at?: InputMaybe<Timestamptz_Comparison_Exp>;
...
export type Contributions_Insert_Input = {
  ...
  contribution_reactions?: InputMaybe<Contribution_Reactions_Arr_Rel_Insert_Input>;
  created_at?: InputMaybe<Scalars["timestamptz"]["input"]>;
...
export type Contributions_Order_By = {
  ...
  contribution_reactions_aggregate?: InputMaybe<Contribution_Reactions_Aggregate_Order_By>;
  created_at?: InputMaybe<Order_By>;
  external_id?: InputMaybe<Order_By>;
  id?: InputMaybe<Order_By>;
  note?: InputMaybe<Order_By>;
...
export type Mutation_Root = {
  ...
  delete_contribution_reactions?: Maybe<Contribution_Reactions_Mutation_Response>;
  /** delete single row from the table: "contribution_reactions" */
  delete_contribution_reactions_by_pk?: Maybe<Contribution_Reactions>;
  ...
  delete_reaction_types?: Maybe<Reaction_Types_Mutation_Response>;
  /** delete single row from the table: "reaction_types" */
  delete_reaction_types_by_pk?: Maybe<Reaction_Types>;
  ...
  insert_contribution_reactions?: Maybe<Contribution_Reactions_Mutation_Response>;
  /** insert a single row into the table: "contribution_reactions" */
  insert_contribution_reactions_one?: Maybe<Contribution_Reactions>;
  ...
  insert_reaction_types?: Maybe<Reaction_Types_Mutation_Response>;
  /** insert a single row into the table: "reaction_types" */
  insert_reaction_types_one?: Maybe<Reaction_Types>;
  ...
  update_contribution_bookmarks_many?: Maybe<
    Array<Maybe<Contribution_Bookmarks_Mutation_Response>>
  >;
  ...
  update_contribution_reactions?: Maybe<Contribution_Reactions_Mutation_Response>;
  /** update single row of the table: "contribution_reactions" */
  update_contribution_reactions_by_pk?: Maybe<Contribution_Reactions>;
  /** update multiples rows of table: "contribution_reactions" */
  update_contribution_reactions_many?: Maybe<
    Array<Maybe<Contribution_Reactions_Mutation_Response>>
  >;
  ...
  update_reaction_types?: Maybe<Reaction_Types_Mutation_Response>;
  /** update single row of the table: "reaction_types" */
  update_reaction_types_by_pk?: Maybe<Reaction_Types>;
  /** update multiples rows of table: "reaction_types" */
  update_reaction_types_many?: Maybe<Array<Maybe<Reaction_Types_Mutation_Response>>>;
...
/** mutation root */
export type Mutation_RootDelete_Contribution_ReactionsArgs = {
  where: Contribution_Reactions_Bool_Exp;
};

/** mutation root */
export type Mutation_RootDelete_Contribution_Reactions_By_PkArgs = {
  contribution_id: Scalars["uuid"]["input"];
  type: Reaction_Types_Enum;
  user_id: Scalars["uuid"]["input"];
};
...
/** mutation root */
export type Mutation_RootDelete_Reaction_TypesArgs = {
  where: Reaction_Types_Bool_Exp;
};

/** mutation root */
export type Mutation_RootDelete_Reaction_Types_By_PkArgs = {
  type: Scalars["String"]["input"];
};
...
/** mutation root */
export type Mutation_RootInsert_Contribution_ReactionsArgs = {
  objects: Array<Contribution_Reactions_Insert_Input>;
  on_conflict?: InputMaybe<Contribution_Reactions_On_Conflict>;
};

/** mutation root */
export type Mutation_RootInsert_Contribution_Reactions_OneArgs = {
...
/** mutation root */
export type Mutation_RootInsert_Reaction_TypesArgs = {
  objects: Array<Reaction_Types_Insert_Input>;
  on_conflict?: InputMaybe<Reaction_Types_On_Conflict>;
};

/** mutation root */
export type Mutation_RootInsert_Reaction_Types_OneArgs = {
...
/** mutation root */
export type Mutation_RootUpdate_Contribution_ReactionsArgs = {
  _set?: InputMaybe<Contribution_Reactions_Set_Input>;
  where: Contribution_Reactions_Bool_Exp;
};

/** mutation root */
export type Mutation_RootUpdate_Contribution_Reactions_By_PkArgs = {
  _set?: InputMaybe<Contribution_Reactions_Set_Input>;
  pk_columns: Contribution_Reactions_Pk_Columns_Input;
};

/** mutation root */
export type Mutation_RootUpdate_Contribution_Reactions_ManyArgs = {
  updates: Array<Contribution_Reactions_Updates>;
};
...
/** mutation root */
export type Mutation_RootUpdate_Reaction_TypesArgs = {
  _set?: InputMaybe<Reaction_Types_Set_Input>;
  where: Reaction_Types_Bool_Exp;
};

/** mutation root */
export type Mutation_RootUpdate_Reaction_Types_By_PkArgs = {
  _set?: InputMaybe<Reaction_Types_Set_Input>;
  pk_columns: Reaction_Types_Pk_Columns_Input;
};

/** mutation root */
export type Mutation_RootUpdate_Reaction_Types_ManyArgs = {
  updates: Array<Reaction_Types_Updates>;
};
...
export type Query_Root = {
  ...
  contribution_reactions_by_pk?: Maybe<Contribution_Reactions>;
  /** An array relationship */
  ...
  reaction_types: Array<Reaction_Types>;
  /** fetch aggregated fields from the table: "reaction_types" */
  reaction_types_aggregate: Reaction_Types_Aggregate;
  /** fetch data from the table: "reaction_types" using primary key columns */
  reaction_types_by_pk?: Maybe<Reaction_Types>;
...
export type Query_RootContribution_ReactionsArgs = {
  distinct_on?: InputMaybe<Array<Contribution_Reactions_Select_Column>>;
  limit?: InputMaybe<Scalars["Int"]["input"]>;
  offset?: InputMaybe<Scalars["Int"]["input"]>;
  order_by?: InputMaybe<Array<Contribution_Reactions_Order_By>>;
...
export type Query_RootContribution_Reactions_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Contribution_Reactions_Select_Column>>;
  limit?: InputMaybe<Scalars["Int"]["input"]>;
  offset?: InputMaybe<Scalars["Int"]["input"]>;
  order_by?: InputMaybe<Array<Contribution_Reactions_Order_By>>;
...
export type Query_RootContribution_Reactions_By_PkArgs = {
  contribution_id: Scalars["uuid"]["input"];
  type: Reaction_Types_Enum;
  user_id: Scalars["uuid"]["input"];
};
...
export type Query_RootReaction_TypesArgs = {
  distinct_on?: InputMaybe<Array<Reaction_Types_Select_Column>>;
  limit?: InputMaybe<Scalars["Int"]["input"]>;
  offset?: InputMaybe<Scalars["Int"]["input"]>;
  order_by?: InputMaybe<Array<Reaction_Types_Order_By>>;
  where?: InputMaybe<Reaction_Types_Bool_Exp>;
};

export type Query_RootReaction_Types_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Reaction_Types_Select_Column>>;
  limit?: InputMaybe<Scalars["Int"]["input"]>;
  offset?: InputMaybe<Scalars["Int"]["input"]>;
  order_by?: InputMaybe<Array<Reaction_Types_Order_By>>;
...
export type Query_RootReaction_Types_By_PkArgs = {
  type: Scalars["String"]["input"];
};
...
export type Reaction_Types = {
  __typename?: "reaction_types";
  type: Scalars["String"]["output"];
};

/** aggregated selection of "reaction_types" */
export type Reaction_Types_Aggregate = {
  __typename?: "reaction_types_aggregate";
  aggregate?: Maybe<Reaction_Types_Aggregate_Fields>;
  nodes: Array<Reaction_Types>;
};

/** aggregate fields of "reaction_types" */
export type Reaction_Types_Aggregate_Fields = {
  __typename?: "reaction_types_aggregate_fields";
  count: Scalars["Int"]["output"];
  max?: Maybe<Reaction_Types_Max_Fields>;
  min?: Maybe<Reaction_Types_Min_Fields>;
};

/** aggregate fields of "reaction_types" */
export type Reaction_Types_Aggregate_FieldsCountArgs = {
  columns?: InputMaybe<Array<Reaction_Types_Select_Column>>;
  distinct?: InputMaybe<Scalars["Boolean"]["input"]>;
};

/** Boolean expression to filter rows from the table "reaction_types". All fields are combined with a logical 'AND'. */
export type Reaction_Types_Bool_Exp = {
  _and?: InputMaybe<Array<Reaction_Types_Bool_Exp>>;
  _not?: InputMaybe<Reaction_Types_Bool_Exp>;
  _or?: InputMaybe<Array<Reaction_Types_Bool_Exp>>;
  type?: InputMaybe<String_Comparison_Exp>;
};

/** unique or primary key constraints on table "reaction_types" */
export enum Reaction_Types_Constraint {
  /** unique or primary key constraint on columns "type" */
  ReactionTypesPkey = "reaction_types_pkey",
}

export enum Reaction_Types_Enum {
  Heart = "heart",
  Hope = "hope",
  Hug = "hug",
  Metoo = "metoo",
...
export type Reaction_Types_Enum_Comparison_Exp = {
  _eq?: InputMaybe<Reaction_Types_Enum>;
  _in?: InputMaybe<Array<Reaction_Types_Enum>>;
  _is_null?: InputMaybe<Scalars["Boolean"]["input"]>;
  _neq?: InputMaybe<Reaction_Types_Enum>;
  _nin?: InputMaybe<Array<Reaction_Types_Enum>>;
};

/** input type for inserting data into table "reaction_types" */
export type Reaction_Types_Insert_Input = {
  type?: InputMaybe<Scalars["String"]["input"]>;
};

/** aggregate max on columns */
export type Reaction_Types_Max_Fields = {
  __typename?: "reaction_types_max_fields";
  type?: Maybe<Scalars["String"]["output"]>;
};

/** aggregate min on columns */
export type Reaction_Types_Min_Fields = {
  __typename?: "reaction_types_min_fields";
  type?: Maybe<Scalars["String"]["output"]>;
};

/** response of any mutation on the table "reaction_types" */
export type Reaction_Types_Mutation_Response = {
  __typename?: "reaction_types_mutation_response";
  /** number of rows affected by the mutation */
  affected_rows: Scalars["Int"]["output"];
  /** data from the rows affected by the mutation */
  returning: Array<Reaction_Types>;
};

/** on_conflict condition type for table "reaction_types" */
export type Reaction_Types_On_Conflict = {
  constraint: Reaction_Types_Constraint;
  update_columns?: Array<Reaction_Types_Update_Column>;
  where?: InputMaybe<Reaction_Types_Bool_Exp>;
};

/** Ordering options when selecting data from "reaction_types". */
export type Reaction_Types_Order_By = {
  type?: InputMaybe<Order_By>;
};

/** primary key columns input for table: reaction_types */
export type Reaction_Types_Pk_Columns_Input = {
  type: Scalars["String"]["input"];
};

/** select columns of table "reaction_types" */
export enum Reaction_Types_Select_Column {
  /** column name */
  Type = "type",
}

/** input type for updating data in table "reaction_types" */
export type Reaction_Types_Set_Input = {
  type?: InputMaybe<Scalars["String"]["input"]>;
};

/** Streaming cursor of the table "reaction_types" */
export type Reaction_Types_Stream_Cursor_Input = {
  /** Stream column input with initial value */
...
/** Initial value of the column from where the streaming should start */
export type Reaction_Types_Stream_Cursor_Value_Input = {
  type?: InputMaybe<Scalars["String"]["input"]>;
};

/** update columns of table "reaction_types" */
export enum Reaction_Types_Update_Column {
  /** column name */
  Type = "type",
}

export type Reaction_Types_Updates = {
  /** sets the columns of the filtered rows to the given values */
  _set?: InputMaybe<Reaction_Types_Set_Input>;
  /** filter the rows which have to be updated */
  where: Reaction_Types_Bool_Exp;
...
export type Subscription_Root = {
  ...
  contribution_reactions_stream: Array<Contribution_Reactions>;
  /** An array relationship */
  contribution_reports: Array<Contribution_Reports>;
  /** An aggregate relationship */
  contribution_reports_aggregate: Contribution_Reports_Aggregate;
  ...
  reaction_types_stream: Array<Reaction_Types>;
  /** fetch data from the table: "auth.users" using primary key columns */
  user?: Maybe<Users>;
  /** An array relationship */
  user_blocks: Array<User_Blocks>;
...
export type Subscription_RootContribution_ReactionsArgs = {
  distinct_on?: InputMaybe<Array<Contribution_Reactions_Select_Column>>;
  limit?: InputMaybe<Scalars["Int"]["input"]>;
  offset?: InputMaybe<Scalars["Int"]["input"]>;
  order_by?: InputMaybe<Array<Contribution_Reactions_Order_By>>;
...
export type Subscription_RootContribution_Reactions_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Contribution_Reactions_Select_Column>>;
  limit?: InputMaybe<Scalars["Int"]["input"]>;
  offset?: InputMaybe<Scalars["Int"]["input"]>;
  order_by?: InputMaybe<Array<Contribution_Reactions_Order_By>>;
...
export type Subscription_RootContribution_Reactions_By_PkArgs = {
  contribution_id: Scalars["uuid"]["input"];
  type: Reaction_Types_Enum;
  user_id: Scalars["uuid"]["input"];
};

export type Subscription_RootContribution_Reactions_StreamArgs = {
  batch_size: Scalars["Int"]["input"];
  cursor: Array<InputMaybe<Contribution_Reactions_Stream_Cursor_Input>>;
  where?: InputMaybe<Contribution_Reactions_Bool_Exp>;
};
...
export type Subscription_RootReaction_TypesArgs = {
  distinct_on?: InputMaybe<Array<Reaction_Types_Select_Column>>;
  limit?: InputMaybe<Scalars["Int"]["input"]>;
  offset?: InputMaybe<Scalars["Int"]["input"]>;
  order_by?: InputMaybe<Array<Reaction_Types_Order_By>>;
...
export type Subscription_RootReaction_Types_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Reaction_Types_Select_Column>>;
  limit?: InputMaybe<Scalars["Int"]["input"]>;
  offset?: InputMaybe<Scalars["Int"]["input"]>;
  order_by?: InputMaybe<Array<Reaction_Types_Order_By>>;
...
export type Subscription_RootReaction_Types_By_PkArgs = {
  type: Scalars["String"]["input"];
};

export type Subscription_RootReaction_Types_StreamArgs = {
  batch_size: Scalars["Int"]["input"];
  cursor: Array<InputMaybe<Reaction_Types_Stream_Cursor_Input>>;
  where?: InputMaybe<Reaction_Types_Bool_Exp>;
};
...
export type GetContributionsByBlogQuery = {
  __typename?: "query_root";
  contributions: Array<{
    __typename?: "contributions";
    id: string;
...
export type GetCommentsBySlugQuery = {
  __typename?: "query_root";
...
export type InsertBlogCommentMutation = {
  __typename?: "mutation_root";
...
export type GetContributionCommentsQuery = {
  ...
  contribution_comments_aggregate: {
    __typename?: "contribution_comments_aggregate";
    aggregate?: { __typename?: "contribution_comments_aggregate_fields"; count: number } | null;
  };
...
export type InsertContributionCommentMutation = {
  __typename?: "mutation_root";
  insert_contribution_comments_one?: { __typename?: "contribution_comments"; id: string } | null;
};
...
export type GetPopularContributionsQuery = {
  ...
  contributions: Array<{
    ...
    reactions_heart: {
      __typename?: "contribution_reactions_aggregate";
      aggregate?: { __typename?: "contribution_reactions_aggregate_fields"; count: number } | null;
    };
    reactions_hug: {
      __typename?: "contribution_reactions_aggregate";
      aggregate?: { __typename?: "contribution_reactions_aggregate_fields"; count: number } | null;
...
export type GetContributionReactionsQueryVariables = Exact<{
  id: Scalars["uuid"]["input"];
}>;

export type GetContributionReactionsQuery = {
  __typename?: "query_root";
  contribution_reactions: Array<{
    __typename?: "contribution_reactions";
    user_id: string;
    type: Reaction_Types_Enum;
  }>;
...
export type AddContributionReactionMutationVariables = Exact<{
  id: Scalars["uuid"]["input"];
  type: Reaction_Types_Enum;
}>;

export type AddContributionReactionMutation = {
  __typename?: "mutation_root";
...
export type RemoveContributionReactionMutationVariables = Exact<{
  id: Scalars["uuid"]["input"];
  userId: Scalars["uuid"]["input"];
  type: Reaction_Types_Enum;
}>;

export type RemoveContributionReactionMutation = {
  __typename?: "mutation_root";
  delete_contribution_reactions_by_pk?: {
    __typename?: "contribution_reactions";
    contribution_id: string;
    user_id: string;
    type: Reaction_Types_Enum;
...
export const useGetLatestPostsQuery = <TData = GetLatestPostsQuery, TError = unknown>(
  variables?: GetLatestPostsQueryVariables,
  options?: Omit<UseQueryOptions<GetLatestPostsQuery, TError, TData>, "queryKey"> & {
    queryKey?: UseQueryOptions<GetLatestPostsQuery, TError, TData>["queryKey"];
  },
) => {
  return useQuery<GetLatestPostsQuery, TError, TData>({
    queryKey: variables === undefined ? ["GetLatestPosts"] : ["GetLatestPosts", variables],
    queryFn: useAuthenticatedFetcher<GetLatestPostsQuery, GetLatestPostsQueryVariables>(
...
useGetLatestPostsQuery.getKey = (variables?: GetLatestPostsQueryVariables) =>
  variables === undefined ? ["GetLatestPosts"] : ["GetLatestPosts", variables];
...
>(
  ...
  options?: Omit<UseQueryOptions<GetContributionsByBlogQuery, TError, TData>, "queryKey"> & {
    queryKey?: UseQueryOptions<GetContributionsByBlogQuery, TError, TData>["queryKey"];
  },
) => {
  return useQuery<GetContributionsByBlogQuery, TError, TData>({
    ...
    queryFn: useAuthenticatedFetcher<
      GetContributionsByBlogQuery,
      GetContributionsByBlogQueryVariables
    >(GetContributionsByBlogDocument).bind(null, variables),
    ...options,
  });
};

useGetContributionsByBlogQuery.getKey = (variables: GetContributionsByBlogQueryVariables) => [
  "GetContributionsByBlog",
  variables,
];
...
export const useInsertPostMutation = <TError = unknown, TContext = unknown>(
  ...
  return useMutation<InsertPostMutation, TError, InsertPostMutationVariables, TContext>({
    ...
    mutationFn: useAuthenticatedFetcher<InsertPostMutation, InsertPostMutationVariables>(
      InsertPostDocument,
    ),
    ...options,
  });
...
export const useGetCommentsBySlugQuery = <TData = GetCommentsBySlugQuery, TError = unknown>(
  variables: GetCommentsBySlugQueryVariables,
  options?: Omit<UseQueryOptions<GetCommentsBySlugQuery, TError, TData>, "queryKey"> & {
    queryKey?: UseQueryOptions<GetCommentsBySlugQuery, TError, TData>["queryKey"];
  },
) => {
  return useQuery<GetCommentsBySlugQuery, TError, TData>({
    queryKey: ["GetCommentsBySlug", variables],
    queryFn: useAuthenticatedFetcher<GetCommentsBySlugQuery, GetCommentsBySlugQueryVariables>(
      GetCommentsBySlugDocument,
    ).bind(null, variables),
    ...options,
  });
};

useGetCommentsBySlugQuery.getKey = (variables: GetCommentsBySlugQueryVariables) => [
  "GetCommentsBySlug",
  variables,
];
...
export const useInsertBlogCommentMutation = <TError = unknown, TContext = unknown>(
...
>(
  ...
  options?: Omit<UseQueryOptions<GetContributionCommentsQuery, TError, TData>, "queryKey"> & {
    queryKey?: UseQueryOptions<GetContributionCommentsQuery, TError, TData>["queryKey"];
  },
) => {
  return useQuery<GetContributionCommentsQuery, TError, TData>({
    queryKey: ["GetContributionComments", variables],
    queryFn: useAuthenticatedFetcher<
      GetContributionCommentsQuery,
      GetContributionCommentsQueryVariables
    >(GetContributionCommentsDocument).bind(null, variables),
    ...options,
  });
};

useGetContributionCommentsQuery.getKey = (variables: GetContributionCommentsQueryVariables) => [
...
export const useInsertContributionCommentMutation = <TError = unknown, TContext = unknown>(
  options?: UseMutationOptions<
    InsertContributionCommentMutation,
    TError,
    InsertContributionCommentMutationVariables,
    TContext
  >,
) => {
  return useMutation<
  ...
  >({
    ...
    mutationFn: useAuthenticatedFetcher<
      InsertContributionCommentMutation,
      InsertContributionCommentMutationVariables
    >(InsertContributionCommentDocument),
    ...options,
  });
};
...
export const GetPopularContributionsDocument = `
  ...
  contributions(
    ...
    reactions_heart: contribution_reactions_aggregate(where: {type: {_eq: heart}}) {
      aggregate {
        count
      }
    }
    reactions_hug: contribution_reactions_aggregate(where: {type: {_eq: hug}}) {
      aggregate {
        count
      }
    }
    reactions_metoo: contribution_reactions_aggregate(where: {type: {_eq: metoo}}) {
      aggregate {
        count
      }
    }
    reactions_hope: contribution_reactions_aggregate(where: {type: {_eq: hope}}) {
      aggregate {
        count
      }
    }
    reactions_thanks: contribution_reactions_aggregate(where: {type: {_eq: thanks}}) {
      aggregate {
        count
      }
    }
...
export const GetContributionReactionsDocument = `
    query GetContributionReactions($id: uuid!) {
  contribution_reactions(where: {contribution_id: {_eq: $id}}) {
    user_id
    type
  }
}
...
export const useGetContributionReactionsQuery = <
  TData = GetContributionReactionsQuery,
  TError = unknown,
>(
  variables: GetContributionReactionsQueryVariables,
  options?: Omit<UseQueryOptions<GetContributionReactionsQuery, TError, TData>, "queryKey"> & {
    queryKey?: UseQueryOptions<GetContributionReactionsQuery, TError, TData>["queryKey"];
  },
) => {
  return useQuery<GetContributionReactionsQuery, TError, TData>({
    queryKey: ["GetContributionReactions", variables],
    queryFn: useAuthenticatedFetcher<
      GetContributionReactionsQuery,
      GetContributionReactionsQueryVariables
    >(GetContributionReactionsDocument).bind(null, variables),
    ...options,
  });
};

useGetContributionReactionsQuery.getKey = (variables: GetContributionReactionsQueryVariables) => [
  "GetContributionReactions",
  variables,
];

export const AddContributionReactionDocument = `
    mutation AddContributionReaction($id: uuid!, $type: reaction_types_enum!) {
  insert_contribution_reactions_one(object: {contribution_id: $id, type: $type}) {
    contribution_id
    user_id
    type
  }
...
export const useAddContributionReactionMutation = <TError = unknown, TContext = unknown>(
  options?: UseMutationOptions<
    AddContributionReactionMutation,
    TError,
    AddContributionReactionMutationVariables,
    TContext
  >,
) => {
  return useMutation<
    ...
    TContext
  >({
    mutationKey: ["AddContributionReaction"],
    mutationFn: useAuthenticatedFetcher<
      AddContributionReactionMutation,
      AddContributionReactionMutationVariables
    >(AddContributionReactionDocument),
    ...options,
  });
};

export const RemoveContributionReactionDocument = `
    mutation RemoveContributionReaction($id: uuid!, $userId: uuid!, $type: reaction_types_enum!) {
  delete_contribution_reactions_by_pk(
    contribution_id: $id
    user_id: $userId
    type: $type
...
export const useRemoveContributionReactionMutation = <TError = unknown, TContext = unknown>(
  options?: UseMutationOptions<
    RemoveContributionReactionMutation,
    TError,
    RemoveContributionReactionMutationVariables,
    TContext
  >,
) => {
  return useMutation<
    ...
    TContext
  >({
    mutationKey: ["RemoveContributionReaction"],
    mutationFn: useAuthenticatedFetcher<
      RemoveContributionReactionMutation,
      RemoveContributionReactionMutationVariables
    >(RemoveContributionReactionDocument),
    ...options,
  });
};
